...
public class BaseClass {
	...
	public String password=data.getUserPass();
	...
	public void setup(String br)
	{
		...
		driver=new ChromeDriver();
				...
				{
				System.setProperty("webdriver.gecko.driver",data.getFirefoxPath());
				driver=new FirefoxDriver();
				}
		else if (br.equals("ie"))
		{
		System.setProperty("webdriver.ie.driver",data.getIePath());
